...
with RedisClient(redis_url="redis://:123@10.5.5.73:16379/v1") as client:
    while True:
        ...
        for k in keys:
            ...
            # print(answer)
            # print(cus_id)
            try:eyJhbGciOiJIUzUxMiJ9..uKWC4U-6J77C9X_g0fCYu9xsIJf7tPa3asgC8mr-bksBmJvL_uKntd9iMSdL6YwSpcJV2u1DRwnzqWoJCxAifg
