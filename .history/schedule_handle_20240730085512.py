...
# 认证token
TOKEN = "eyJhbGciOiJIUzUxMiJ9..8VTIE7uirPUA0Z2OlAeeJfUfy1gjc26DZryRREe-A7nqVdsSJarX9o6xmfehOb9fZiv_SsSi5ym3bFBMr6Qvsg"
...
if __name__ == '__main__':
    ...
    # print(taskId)
    # print(taskName)
    print(extract(10007072))
    print(check(10007072))
