...
# 认证token
TOKEN = "eyJhbGciOiJIUzUxMiJ9..JEiCKSAxpJuTym1G5BLA6maBOvao4bwUL_05VGU0r--CYpF5yoLKpj2mc0oKd9uFIi36GTVIDE7MaeiZStkQbg"

def task_list(task_id:str="", user:str=""):
    url = f"https://dispatcher.essence.com.cn/api/v1/task-approval/approval/waiting"
    ...
    headers = {
        ...
        "Origin": "https://dispatcher.essence.com.cn",
...
def approval(t_id:str, task_id:str, approval=True):
    url = f"https://dispatcher.essence.com.cn/api/v1/task-approval/approval/{t_id}"
    headers = {
        "content-type": "application/json",
        "Authorization": f"Bearer {TOKEN}",
        "Origin": "https://dispatcher.essence.com.cn",
