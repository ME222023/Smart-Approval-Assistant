...
class Info(BaseModel):
    ...
    project_version: str = Field(None, alias='project.version', description="项目版本")
    ...
    hive_sql_file_name: str = Field(None, alias='hive.sql.file.name', description="Hive SQL文件名")
