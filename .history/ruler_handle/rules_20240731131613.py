...
# rule1: 告警时间需晚于生效时间
def r1(info:scheduleInfo) -> str:
    # task = info.get('data', {}).get('taskDtoLatest', {}).get('task', {})
    caution_t = info.unSuccessOverTime
    start_t = info.startDate")
...
if __name__ == "__main__":
    ...
    info_instance = schedule_info(**json_obj1)
    print(info_instance)
