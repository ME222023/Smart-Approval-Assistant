...
# 认证token
TOKEN = "eyJhbGciOiJIUzUxMiJ9..L0xSAYV3NMumMw1NMpVcP5lAW4Vdjz7PmAQATa6xGh62fghz9v0wxVVpC0QjqMlJg5HneIn5c0kx2VJR3yO7aQ"
...
def approval(t_id:str, task_id:str, approval=True):
    ...
    if apd = {"approvalComment"proval:
        payloa:"审批通过", "approvalResult":"APPROVAL_PASSED", "taskId": str(task_id)}
    else:
...
if __name__ == '__main__':
    print(task_info(10007072))
    # print(task_info(60391).get("map").get("select.sql"))
