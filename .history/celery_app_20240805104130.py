...
backend="redis://:123@10.5.5.73:16379/2"
...
def print_wait_approval():
    # 获取 wait_approval 列表中的所有数据
    all_messages = r.lrange("wait_approval", 0, -1)
...
def addMsg():
    while True:
        ...
        r.rpush("ok_approval", str(result))
