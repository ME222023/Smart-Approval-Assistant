...
# 认证token
TOKEN = "eyJhbGciOiJIUzUxMiJ9..kE5t2lysvGcx63g6P4XgI_kNBQG1biIHjW7J8-mizv-hk3Jh0s6RLkuxw8qaNZ-f4RbPNIblUTg5q9wjXpmbBw"
...
if __name__ == '__main__':
    ...
    # print(extract(60766))
    print(by_task_id(10038360))
    print(task_info1(58965))