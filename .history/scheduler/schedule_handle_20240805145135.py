...
# 认证token
TOKEN = "eyJhbGciOiJIUzUxMiJ9..hcIpB2AGkLi8dOOZZc1SdgyUQUF1v0TilAtLQwjf6uT6hc6aLy7qb039qLoMDbhj4jQqtZcxf6fz25JYus8zLA"
...
def task_list(task_id:str="", user:str=""):
    ...
    if task_statu=="操作成功！":
        ...
        raise "登陆失败"
# 待审批任务url：http://dispatcher.k8stest.axzq.com.cn/api/v1/task-approval/approval/61185
# 已审批任务url：http://dispatcher.k8stest.axzq.com.cn/api/v1/task-approval/approval/61187
