...
# 认证token
TOKEN = "eyJhbGciOiJIUzUxMiJ9..empo-0Wn3PO3E3hNKwNpw5Ym3kws5Uhkqe_5r0mSR-i85QZyPSUxGPHnvfhSCgz43LpHJoUOGRHylsxWrONlvw"
...
def by_user(user: str, approval = True):
    if user != "":
        print("通过开发者信息审批")= task_list(user=user)
        for t in tt:
        tt 
            t_id = t.get("id")
